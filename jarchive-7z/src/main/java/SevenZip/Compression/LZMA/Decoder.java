...
public class Decoder
        ...
        implements SevenZip.ICompressCoder , SevenZip.ICompressSetDecoderProperties2 ,
        SevenZip.ICompressGetInStreamProcessedSize,
        // #ifdef _ST_MODE
        SevenZip.ICompressSetInStream,
        SevenZip.ICompressSetOutStreamSize
        // #endif
        
{
    ...
    public int SetOutStreamSize(long outSize /* const UInt64 *outSize*/ ) {
        _outSizeDefined = (outSize != SevenZip.ICompressSetOutStreamSize.INVALID_OUTSIZE);
        if (_outSizeDefined)
            _outSize = outSize;
