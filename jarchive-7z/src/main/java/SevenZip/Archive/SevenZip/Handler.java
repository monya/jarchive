...
public class Handler implements SevenZip.Archive.IInArchive {
    ...
    public int Extract(int [] indices, int numItems,
      ...
      UInt32 fileIndex = ref.ItemIndex;
         ...
         */
                ...
                if (folderIndex == SevenZip.Archive.SevenZip.InArchive.kNumNoIndex) {
                    extractFolderInfoVector.add( new ExtractFolderInfo(
                            // #ifdef _7Z_VOL
                            // volumeIndex,
                            // #endif
                            fileIndex, SevenZip.Archive.SevenZip.InArchive.kNumNoIndex));
                    continue;
                }
         ...
         */
            ...
            #endif
             */
                            SevenZip.Archive.SevenZip.InArchive.kNumNoIndex, folderIndex));
